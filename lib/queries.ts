...
export async function getLatestArticles(): Promise<PublishedArticle[]> {
  return [
    {
      id: 1,
      ...
      article_lead: "De gemeente Voorschoten heeft nieuwe maatregelen aangekondigd om de verkeersdrukte te verminderen.",
      body: "De gemeente heeft besloten om extra verkeersmaatregelen te nemen in het centrum van Voorschoten. Dit besluit volgt na meerdere klachten van bewoners over drukte en veiligheid.",
    ...
    },
    {
      ...
      article_lead: "De jaarlijkse sportdag in Voorschoten was opnieuw een groot succes.",
      body: "Honderden inwoners kwamen af op de sportdag. Verschillende verenigingen presenteerden zich en er waren activiteiten voor jong en oud.",
      published_at: new Date().toISOString(),
      updated_at: null,
      image_strategy_used: "fallback_stock"
    }
